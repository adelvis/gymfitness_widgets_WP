...
/*
    ...
    Plugin URI:
    Description: Agrega Widgets al sitio  Gimnacio Fitness
    Version:1.0.0
...
class Gymfitness_Class_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			array( 'description' => esc_html__( 'Agrega las clase como Widget', 'text_domain' ), ) // Args
		);
	}
...
} // class Gymfitness_Class_Widget

// register Gymfitness_Class_Widget widget
